...
export class AssetsService {
  ...
  addAssets(myFile:any,companyId:string):Observable<any>{
    ...
    return this.httpClient.post(this.assetEndpoint+"import/"+companyId,myFile,{headers});
  }
  uploadImage(data:any):Observable<any>{
    ...
    return this.httpClient.post(this.assetEndpoint+"imageUpload",data,{headers});
  }
  removeImage(id:string):Observable<any>{
    ...
    return this.httpClient.post(this.assetEndpoint+"removeImage",id,{headers});
  }
  removeAsset(id:string):Observable<any>{
    ...
    return this.httpClient.post(this.assetEndpoint+"removeAsset",id,{headers});
  }
  getExtraFieldName(id:string):Observable<any>{
    ...
    return this.httpClient.get(this.assetEndpoint+"getExtraFieldName/"+id,{headers});
  }
  getExtraFieldNameValue(companyId:string):Observable<any>{
    ...
    return this.httpClient.get(this.assetEndpoint+"getExtraFieldNameValue/"+companyId,{headers});
  }
  ...
  getMandatoryFields(name:any,companyId:any):Observable<any>{
    ...
    return this.httpClient.get(this.assetEndpoint+"getMandatoryFields/"+name+"/"+companyId,{headers});
  }
  getShowFields(name:any,companyId:any):Observable<any>{
    ...
    return this.httpClient.get(this.assetEndpoint+"getShowFields/"+name+"/"+companyId,{headers});
  }
  getAllMandatoryFields(companyId:any):Observable<any>{
    ...
    return this.httpClient.get(this.assetEndpoint+"getAllMandatoryFields/"+companyId,{headers});
  }
  getAllShowFields(companyId:any):Observable<any>{
    ...
    return this.httpClient.get(this.assetEndpoint+"getAllShowFields/"+companyId,{headers});
  }
  addNewAsset(data:any):Observable<any>{
    ...
    return this.httpClient.post(this.assetEndpoint+"addNewAssets",data,{headers});
  }
  addExtraFields(data:any):Observable<any>{
    ...
    return this.httpClient.post(this.assetEndpoint+"addfields",data,{headers});
  }
  exportexcel(): void 
    {
    ...
    getAssetsAllDetails(companyId:any):Observable<any>{
      ...
      return this.httpClient.get(this.assetEndpoint+"getAllAssetData/"+companyId,{headers});
    }
    ...
    advanceFilter(data:any,pageIndex:number,pageSize:number,category:any,searchData:any,asc:any):Observable<any>{
      ...
      return this.httpClient.post(this.assetEndpoint+"advanceFilter/"+pageIndex+'/'+pageSize+"?category="+category+"&search="+searchData+"&asc="+asc,data,{headers});
    ...
    getAssetDetails(id:string):Observable<any>{
      ...
      return this.httpClient.get(this.assetEndpoint+"getAsset/"+id,{headers});
    }
